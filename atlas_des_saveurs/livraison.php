...
verifierSession(['livreur', 'admin']); // accès réservé aux livreurs et admins
...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST["commande_id"])) {
    ...
    foreach ($commandes as &$commande) {
        ...
        if ($commande["id"] == $_POST["commande_id"]) {
            ...
            // sécurité : seul le livreur assigné peut valider
...
<?php foreach ($commandes as $commande): ?>
    ...
    <!-- On affiche uniquement les commandes assignées à ce livreur et en cours -->
    <?php if (($commande['livreur_id'] ?? null) == $user['id'] && $statutCommande === "En livraison"): ?>
        ...
        <section class="actions">
            <form method="POST">
                ...
                <!-- Lien vers Google Maps avec l'adresse de livraison -->
