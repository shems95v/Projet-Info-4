...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    // On cherche l'utilisateur dans le tableau et on met à jour ses infos
    foreach ($backdata as &$user) {
        if ($user["id"] == $idUsers) {
            ...
            $_SESSION["user"] = $user; // on met aussi à jour la session
            break;
        }
    }
...
<body>
    ...
    <!-- Formulaire de modification (caché par défaut, affiché via profil.js) -->
